...
public class PanelWithDrawers2 {
	WebDriver driver;
	...
	public void beforeclass() throws IOException{
		writer = Files.newBufferedWriter(Paths.get(project_path + "/XSLT_Reports/output/drawers2.txt"),StandardCharsets.UTF_8);
	}
    ...
    public void panelWithDrawers() throws InterruptedException, IOException {
		...
		Thread.sleep(1000);
		for (int width = 63 ; width < 93 ; width++){
