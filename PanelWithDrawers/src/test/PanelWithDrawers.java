...
public class PanelWithDrawers {
	...
	public void beforeTest(String url) throws InterruptedException, IOException{
		writer = Files.newBufferedWriter(Paths.get(project_path + "/XSLT_Reports/output/drawers.txt"),StandardCharsets.UTF_8);
		...
		for (int width = 32 ; width < 121 ; width++){
			for (int height = 72 ; height < 85 ; height++){
				try{
					...
					Thread.sleep(2000);
					String path = "//*[@id='step2DoorTypeExternal']";
